...
namespace Kuchen
{
	public static class GameObjectExtension
	{
		...
		public static SubscribeEventChain SubscribeOnce(this MonoBehaviour behaviour, string topic, Action callback)
		{
			var subscriber = GetOrAddComponent<KuchenSubscriberGameObject>(behaviour.gameObject).Subscriber;
			SubscribeEventChain se = null;
		...
		public static SubscribeEventChain SubscribeOnceWithTopic(this MonoBehaviour behaviour, string topic, Action<string> callback)
		{
			var subscriber = GetOrAddComponent<KuchenSubscriberGameObject>(behaviour.gameObject).Subscriber;
			SubscribeEventChain se = null;
		...
		public static SubscribeEventChain SubscribeOnce<T1>(this MonoBehaviour behaviour, string topic, Action<T1> callback)
		{
			var subscriber = GetOrAddComponent<KuchenSubscriberGameObject>(behaviour.gameObject).Subscriber;
			SubscribeEventChain se = null;
			se = subscriber.Subscribe<T1>(topic, (a1) => {
				subscriber.Unsubscribe(se);
				callback(a1);
			});
			return se;
		...
		public static SubscribeEventChain SubscribeOnceWithTopic<T1>(this MonoBehaviour behaviour, string topic, Action<string, T1> callback)
		{
			var subscriber = GetOrAddComponent<KuchenSubscriberGameObject>(behaviour.gameObject).Subscriber;
			SubscribeEventChain se = null;
		...
		public static SubscribeEventChain SubscribeOnce<T1, T2>(this MonoBehaviour behaviour, string topic, Action<T1, T2> callback)
		{
			var subscriber = GetOrAddComponent<KuchenSubscriberGameObject>(behaviour.gameObject).Subscriber;
			SubscribeEventChain se = null;
			se = subscriber.Subscribe<T1, T2>(topic, (a1, a2) => {
				subscriber.Unsubscribe(se);
				callback(a1, a2);
			});
			return se;
		...
		public static SubscribeEventChain SubscribeOnceWithTopic<T1, T2>(this MonoBehaviour behaviour, string topic, Action<string, T1, T2> callback)
		{
			var subscriber = GetOrAddComponent<KuchenSubscriberGameObject>(behaviour.gameObject).Subscriber;
			SubscribeEventChain se = null;
		...
		public static SubscribeEventChain SubscribeOnce<T1, T2, T3>(this MonoBehaviour behaviour, string topic, Action<T1, T2, T3> callback)
		{
			var subscriber = GetOrAddComponent<KuchenSubscriberGameObject>(behaviour.gameObject).Subscriber;
			SubscribeEventChain se = null;
			se = subscriber.Subscribe<T1, T2, T3>(topic, (a1, a2, a3) => {
				subscriber.Unsubscribe(se);
				callback(a1, a2, a3);
			});
			return se;
		...
		public static SubscribeEventChain SubscribeOnceWithTopic<T1, T2, T3>(this MonoBehaviour behaviour, string topic, Action<string, T1, T2, T3> callback)
		{
			var subscriber = GetOrAddComponent<KuchenSubscriberGameObject>(behaviour.gameObject).Subscriber;
			SubscribeEventChain se = null;
